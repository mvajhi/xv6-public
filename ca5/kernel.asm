...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 a1 7e 10 80 	movl   $0x80107ea1,(%esp)
...
80102486:	81 fb 14 59 11 80    	cmp    $0x80115914,%ebx
...
8010305b:	68 14 59 11 80       	push   $0x80115914
...
801041f3:	68 a1 7e 10 80       	push   $0x80107ea1
...
801057b4:	68 60 4d 11 80       	push   $0x80114d60
801057b9:	e8 a2 ed ff ff       	call   80104560 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057be:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057c1:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801057d3:	68 60 4d 11 80       	push   $0x80114d60
801057d8:	68 a0 55 11 80       	push   $0x801155a0
801057dd:	e8 3e e7 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
801057e2:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
80105848:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010584b:	68 60 4d 11 80       	push   $0x80114d60
80105850:	e8 0b ed ff ff       	call   80104560 <acquire>
  xticks = ticks;
80105855:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
8010585b:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
...
8010588a:	78 14                	js     801058a0 <sys_openshmem+0x30>
        cprintf("arg err\n");
        return 0;
    }
...
80105892:	e8 69 19 00 00       	call   80107200 <openshmem>
...
801058a3:	68 21 7c 10 80       	push   $0x80107c21
801058a8:	e8 03 ae ff ff       	call   801006b0 <cprintf>
        return 0;
...
801058d0:	e8 7b f0 ff ff       	call   80104950 <argint>
801058d5:	83 c4 10             	add    $0x10,%esp
801058d8:	85 c0                	test   %eax,%eax
801058da:	78 14                	js     801058f0 <sys_closeshmem+0x30>
        cprintf("arg err\n");
        return 0;
    }
...
801058e2:	e8 89 1a 00 00       	call   80107370 <closeshmem>
...
801058f3:	68 21 7c 10 80       	push   $0x80107c21
801058f8:	e8 b3 ad ff ff       	call   801006b0 <cprintf>
        return 0;
...
8010597e:	00 00 ef 
  initlock(&tickslock, "time");
80105981:	68 2a 7c 10 80       	push   $0x80107c2a
...
801059bf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059c3:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105a04:	3e ff 24 85 d0 7c 10 	notrack jmp *-0x7fef8330(,%eax,4)
80105a0b:	80 
    lapiceoi();
    break;
...
80105a61:	68 8c 7c 10 80       	push   $0x80107c8c
...
80105b07:	68 60 4d 11 80       	push   $0x80114d60
80105b0c:	e8 4f ea ff ff       	call   80104560 <acquire>
      wakeup(&ticks);
80105b11:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105b18:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105b1f:	e8 bc e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b24:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105b2b:	e8 f0 ea ff ff       	call   80104620 <release>
...
80105b7c:	68 34 7c 10 80       	push   $0x80107c34
...
80105bc9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bcc:	e8 6f ee ff ff       	call   80104a40 <syscall>
    if(myproc()->killed)
...
80105c18:	68 58 7c 10 80       	push   $0x80107c58
80105c1d:	e8 8e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c22:	83 c4 14             	add    $0x14,%esp
80105c25:	68 2f 7c 10 80       	push   $0x80107c2f
...
80105d23:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d28:	bb 50 7d 10 80       	mov    $0x80107d50,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010688a:	e8 e1 dd ff ff       	call   80104670 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010692d:	68 58 7d 10 80       	push   $0x80107d58
...
801069e3:	68 06 77 10 80       	push   $0x80107706
...
80106a84:	a1 c0 55 11 80       	mov    0x801155c0,%eax
...
80106ac8:	0f 84 c2 00 00 00    	je     80106b90 <switchuvm+0xf0>
  pushcli();
80106ace:	e8 8d d9 ff ff       	call   80104460 <pushcli>
...
80106be3:	e8 88 da ff ff       	call   80104670 <memset>
...
80106c16:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c17:	e9 f4 da ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106c1c:	83 ec 0c             	sub    $0xc,%esp
80106c1f:	68 9d 7d 10 80       	push   $0x80107d9d
...
80106d89:	68 d5 7d 10 80       	push   $0x80107dd5
...
80106deb:	68 ed 7d 10 80       	push   $0x80107ded
...
80106ecc:	68 09 7e 10 80       	push   $0x80107e09
...
80106f04:	e8 67 d7 ff ff       	call   80104670 <memset>
...
80106f6f:	a3 c0 55 11 80       	mov    %eax,0x801155c0
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fa3:	68 1a 7e 10 80       	push   $0x80107e1a
...
80107089:	68 3e 7e 10 80       	push   $0x80107e3e
8010708e:	e8 fd 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107093:	83 ec 0c             	sub    $0xc,%esp
80107096:	68 24 7e 10 80       	push   $0x80107e24
...
8010711e:	e8 ed d5 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;
...
80107175:	ba e0 55 11 80       	mov    $0x801155e0,%edx
    for (int i = 0; i < NSHPAGE; i++)
8010717a:	31 c0                	xor    %eax,%eax
{
8010717c:	89 e5                	mov    %esp,%ebp
8010717e:	57                   	push   %edi
8010717f:	56                   	push   %esi
80107180:	53                   	push   %ebx
80107181:	83 ec 0c             	sub    $0xc,%esp
80107184:	8b 4d 08             	mov    0x8(%ebp),%ecx
80107187:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010718a:	eb 0f                	jmp    8010719b <lookup_table+0x2b>
8010718c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (int i = 0; i < NSHPAGE; i++)
80107190:	83 c0 01             	add    $0x1,%eax
80107193:	83 c2 0c             	add    $0xc,%edx
80107196:	83 f8 40             	cmp    $0x40,%eax
80107199:	74 55                	je     801071f0 <lookup_table+0x80>
    {
        if (shared_memory_table.pages[i].id == id)
8010719b:	39 0a                	cmp    %ecx,(%edx)
8010719d:	75 f1                	jne    80107190 <lookup_table+0x20>
        {
            shared_memory_table.pages[i].n_access++;
8010719f:	8d 04 40             	lea    (%eax,%eax,2),%eax
...
801071a5:	b9 00 10 00 00       	mov    $0x1000,%ecx
            shared_memory_table.pages[i].n_access++;
801071aa:	8d 04 85 e0 55 11 80 	lea    -0x7feeaa20(,%eax,4),%eax
801071b1:	83 40 04 01          	addl   $0x1,0x4(%eax)
            char *vaddr = (char *)PGROUNDUP(proc->sz);
801071b5:	8b 3b                	mov    (%ebx),%edi
801071b7:	8d b7 ff 0f 00 00    	lea    0xfff(%edi),%esi
            if (mappages(proc->pgdir, vaddr, PGSIZE, shared_memory_table.pages[i].physical_addr, PTE_W | PTE_U) < 0)
801071bd:	8b 7b 04             	mov    0x4(%ebx),%edi
801071c0:	6a 06                	push   $0x6
801071c2:	ff 70 08             	pushl  0x8(%eax)
            char *vaddr = (char *)PGROUNDUP(proc->sz);
801071c5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
            if (mappages(proc->pgdir, vaddr, PGSIZE, shared_memory_table.pages[i].physical_addr, PTE_W | PTE_U) < 0)
801071cb:	89 f2                	mov    %esi,%edx
801071cd:	89 f8                	mov    %edi,%eax
801071cf:	e8 dc f6 ff ff       	call   801068b0 <mappages>
801071d4:	83 c4 10             	add    $0x10,%esp
801071d7:	85 c0                	test   %eax,%eax
801071d9:	78 15                	js     801071f0 <lookup_table+0x80>
                return (char *)-1;
            proc->sz += PGSIZE;
801071db:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
...
801071e1:	89 f0                	mov    %esi,%eax
            proc->shmemaddr = (uint)vaddr;
801071e3:	89 73 7c             	mov    %esi,0x7c(%ebx)
}
...
801071f0:	8d 65 f4             	lea    -0xc(%ebp),%esp
                return (char *)-1;
801071f3:	be ff ff ff ff       	mov    $0xffffffff,%esi
}
801071f8:	5b                   	pop    %ebx
...
80107210:	68 e0 58 11 80       	push   $0x801158e0
80107215:	e8 46 d3 ff ff       	call   80104560 <acquire>
    struct proc* proc = myproc();
8010721a:	e8 41 c7 ff ff       	call   80103960 <myproc>
...
80107221:	50                   	push   %eax
    struct proc* proc = myproc();
80107222:	89 c3                	mov    %eax,%ebx
    char *ret = lookup_table(id, proc);
80107224:	56                   	push   %esi
80107225:	e8 46 ff ff ff       	call   80107170 <lookup_table>
    if ((int)ret != -1){
8010722a:	83 c4 10             	add    $0x10,%esp
8010722d:	b9 e0 55 11 80       	mov    $0x801155e0,%ecx
    char *ret = lookup_table(id, proc);
80107232:	89 c7                	mov    %eax,%edi
    if ((int)ret != -1){
80107234:	31 c0                	xor    %eax,%eax
80107236:	83 ff ff             	cmp    $0xffffffff,%edi
80107239:	74 14                	je     8010724f <openshmem+0x4f>
8010723b:	e9 8f 00 00 00       	jmp    801072cf <openshmem+0xcf>
...
80107243:	83 c1 0c             	add    $0xc,%ecx
80107246:	83 f8 40             	cmp    $0x40,%eax
80107249:	0f 84 a1 00 00 00    	je     801072f0 <openshmem+0xf0>
        if (shared_memory_table.pages[i].id == 0) {
8010724f:	8b 11                	mov    (%ecx),%edx
80107251:	85 d2                	test   %edx,%edx
80107253:	75 eb                	jne    80107240 <openshmem+0x40>
            page_index = i;
            shared_memory_table.pages[i].id = id;
80107255:	8d 04 40             	lea    (%eax,%eax,2),%eax
80107258:	c1 e0 02             	shl    $0x2,%eax
8010725b:	8d 90 e0 55 11 80    	lea    -0x7feeaa20(%eax),%edx
80107261:	89 b0 e0 55 11 80    	mov    %esi,-0x7feeaa20(%eax)
80107267:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
8010726a:	e8 c1 b3 ff ff       	call   80102630 <kalloc>
8010726f:	89 c6                	mov    %eax,%esi
    if (physical_address == 0) {
80107271:	85 c0                	test   %eax,%eax
80107273:	0f 84 cd 00 00 00    	je     80107346 <openshmem+0x146>
...
8010727c:	81 c6 00 00 00 80    	add    $0x80000000,%esi
    memset(physical_address, 0, PGSIZE);
80107282:	68 00 10 00 00       	push   $0x1000
80107287:	6a 00                	push   $0x0
80107289:	50                   	push   %eax
8010728a:	e8 e1 d3 ff ff       	call   80104670 <memset>
    char* vaddr = (char*)PGROUNDUP(proc->sz);
8010728f:	8b 03                	mov    (%ebx),%eax
...
80107294:	b9 00 10 00 00       	mov    $0x1000,%ecx
    char* vaddr = (char*)PGROUNDUP(proc->sz);
80107299:	8d 90 ff 0f 00 00    	lea    0xfff(%eax),%edx
    shared_memory_table.pages[page_index].physical_addr = (uint)V2P(physical_address);
8010729f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    char* vaddr = (char*)PGROUNDUP(proc->sz);
801072a2:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
    shared_memory_table.pages[page_index].physical_addr = (uint)V2P(physical_address);
801072a8:	89 70 08             	mov    %esi,0x8(%eax)
    if (mappages(proc->pgdir, vaddr, PGSIZE, shared_memory_table.pages[page_index].physical_addr, PTE_W | PTE_U) < 0) {
801072ab:	8b 43 04             	mov    0x4(%ebx),%eax
    char* vaddr = (char*)PGROUNDUP(proc->sz);
801072ae:	89 d7                	mov    %edx,%edi
    if (mappages(proc->pgdir, vaddr, PGSIZE, shared_memory_table.pages[page_index].physical_addr, PTE_W | PTE_U) < 0) {
801072b0:	6a 06                	push   $0x6
801072b2:	56                   	push   %esi
801072b3:	e8 f8 f5 ff ff       	call   801068b0 <mappages>
801072b8:	83 c4 10             	add    $0x10,%esp
801072bb:	85 c0                	test   %eax,%eax
801072bd:	78 61                	js     80107320 <openshmem+0x120>
...
801072c2:	83 40 04 01          	addl   $0x1,0x4(%eax)
    proc->sz += PGSIZE;
801072c6:	81 03 00 10 00 00    	addl   $0x1000,(%ebx)
    proc->shmemaddr = (uint)vaddr;
801072cc:	89 7b 7c             	mov    %edi,0x7c(%ebx)

    release(&shared_memory_table.lock);
801072cf:	83 ec 0c             	sub    $0xc,%esp
801072d2:	68 e0 58 11 80       	push   $0x801158e0
801072d7:	e8 44 d3 ff ff       	call   80104620 <release>
    return vaddr;
...
801072f3:	68 69 7e 10 80       	push   $0x80107e69
801072f8:	e8 b3 93 ff ff       	call   801006b0 <cprintf>
        release(&shared_memory_table.lock);
801072fd:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
80107304:	e8 17 d3 ff ff       	call   80104620 <release>
        return (char*)-1;
80107309:	83 c4 10             	add    $0x10,%esp
}
8010730c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010730f:	89 f8                	mov    %edi,%eax
80107311:	5b                   	pop    %ebx
80107312:	5e                   	pop    %esi
80107313:	5f                   	pop    %edi
80107314:	5d                   	pop    %ebp
...
80107323:	68 58 7e 10 80       	push   $0x80107e58
80107328:	e8 83 93 ff ff       	call   801006b0 <cprintf>
        release(&shared_memory_table.lock);
8010732d:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
80107334:	e8 e7 d2 ff ff       	call   80104620 <release>
        return vaddr;
80107339:	83 c4 10             	add    $0x10,%esp
}
8010733c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010733f:	89 f8                	mov    %edi,%eax
80107341:	5b                   	pop    %ebx
80107342:	5e                   	pop    %esi
80107343:	5f                   	pop    %edi
80107344:	5d                   	pop    %ebp
...
80107349:	68 de 7d 10 80       	push   $0x80107dde
8010734e:	e8 5d 93 ff ff       	call   801006b0 <cprintf>
        release(&shared_memory_table.lock);
80107353:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
8010735a:	e8 c1 d2 ff ff       	call   80104620 <release>
        return (char*)-1;
8010735f:	83 c4 10             	add    $0x10,%esp
80107362:	e9 78 ff ff ff       	jmp    801072df <openshmem+0xdf>
...
80107379:	8b 75 08             	mov    0x8(%ebp),%esi
    ...
    int page_index = -1;
    for(int i = 0; i < NSHPAGE; i++) {
8010737c:	31 db                	xor    %ebx,%ebx
    acquire(&shared_memory_table.lock);
8010737e:	83 ec 0c             	sub    $0xc,%esp
80107381:	68 e0 58 11 80       	push   $0x801158e0
80107386:	e8 d5 d1 ff ff       	call   80104560 <acquire>
    for(int i = 0; i < NSHPAGE; i++) {
8010738b:	b8 e0 55 11 80       	mov    $0x801155e0,%eax
80107390:	83 c4 10             	add    $0x10,%esp
80107393:	eb 12                	jmp    801073a7 <closeshmem+0x37>
80107395:	8d 76 00             	lea    0x0(%esi),%esi
80107398:	83 c3 01             	add    $0x1,%ebx
8010739b:	83 c0 0c             	add    $0xc,%eax
8010739e:	83 fb 40             	cmp    $0x40,%ebx
801073a1:	0f 84 b9 00 00 00    	je     80107460 <closeshmem+0xf0>
        if(shared_memory_table.pages[i].id == id) {
801073a7:	39 30                	cmp    %esi,(%eax)
801073a9:	75 ed                	jne    80107398 <closeshmem+0x28>
    ...
    struct proc *proc = myproc();
801073ab:	e8 b0 c5 ff ff       	call   80103960 <myproc>
    pte_t* pte = walkpgdir(proc->pgdir, (char*)PGROUNDUP(proc->shmemaddr), 0);
    *pte = 0;

    shared_memory_table.pages[page_index].n_access--;
801073b0:	8d 34 5b             	lea    (%ebx,%ebx,2),%esi
    pte_t* pte = walkpgdir(proc->pgdir, (char*)PGROUNDUP(proc->shmemaddr), 0);
801073b3:	8b 48 7c             	mov    0x7c(%eax),%ecx
801073b6:	8b 40 04             	mov    0x4(%eax),%eax
    shared_memory_table.pages[page_index].n_access--;
801073b9:	c1 e6 02             	shl    $0x2,%esi
    pte_t* pte = walkpgdir(proc->pgdir, (char*)PGROUNDUP(proc->shmemaddr), 0);
801073bc:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
801073c2:	31 c9                	xor    %ecx,%ecx
801073c4:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
801073ca:	e8 61 f4 ff ff       	call   80106830 <walkpgdir>
    *pte = 0;
801073cf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    shared_memory_table.pages[page_index].n_access--;
801073d5:	8d 86 e0 55 11 80    	lea    -0x7feeaa20(%esi),%eax
801073db:	8b 48 04             	mov    0x4(%eax),%ecx
801073de:	8d 59 ff             	lea    -0x1(%ecx),%ebx
801073e1:	89 58 04             	mov    %ebx,0x4(%eax)
    if(shared_memory_table.pages[page_index].n_access != 0) {
801073e4:	85 db                	test   %ebx,%ebx
801073e6:	75 48                	jne    80107430 <closeshmem+0xc0>
        cprintf("closed\n");
        release(&shared_memory_table.lock);
        return 0;
    }
...
801073e8:	8b 40 08             	mov    0x8(%eax),%eax
801073eb:	83 ec 0c             	sub    $0xc,%esp
801073ee:	05 00 00 00 80       	add    $0x80000000,%eax
801073f3:	50                   	push   %eax
801073f4:	e8 77 b0 ff ff       	call   80102470 <kfree>
    shared_memory_table.pages[page_index].id = 0;

    cprintf("closed and free\n");
801073f9:	c7 04 24 81 7e 10 80 	movl   $0x80107e81,(%esp)
    shared_memory_table.pages[page_index].id = 0;
80107400:	c7 86 e0 55 11 80 00 	movl   $0x0,-0x7feeaa20(%esi)
80107407:	00 00 00 
    cprintf("closed and free\n");
8010740a:	e8 a1 92 ff ff       	call   801006b0 <cprintf>
    release(&shared_memory_table.lock);
8010740f:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
80107416:	e8 05 d2 ff ff       	call   80104620 <release>
    return 0;
8010741b:	83 c4 10             	add    $0x10,%esp
8010741e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107421:	89 d8                	mov    %ebx,%eax
80107423:	5b                   	pop    %ebx
80107424:	5e                   	pop    %esi
80107425:	5d                   	pop    %ebp
80107426:	c3                   	ret    
...
80107430:	83 ec 0c             	sub    $0xc,%esp
        return 0;
80107433:	31 db                	xor    %ebx,%ebx
        cprintf("closed\n");
80107435:	68 79 7e 10 80       	push   $0x80107e79
8010743a:	e8 71 92 ff ff       	call   801006b0 <cprintf>
        release(&shared_memory_table.lock);
8010743f:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
80107446:	e8 d5 d1 ff ff       	call   80104620 <release>
        return 0;
8010744b:	83 c4 10             	add    $0x10,%esp
8010744e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107451:	89 d8                	mov    %ebx,%eax
80107453:	5b                   	pop    %ebx
80107454:	5e                   	pop    %esi
80107455:	5d                   	pop    %ebp
80107456:	c3                   	ret    
...
80107460:	83 ec 0c             	sub    $0xc,%esp
        return -1;
80107463:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
        cprintf("page not found!\n");
80107468:	68 92 7e 10 80       	push   $0x80107e92
8010746d:	e8 3e 92 ff ff       	call   801006b0 <cprintf>
        release(&shared_memory_table.lock);
80107472:	c7 04 24 e0 58 11 80 	movl   $0x801158e0,(%esp)
80107479:	e8 a2 d1 ff ff       	call   80104620 <release>
        return -1;
8010747e:	83 c4 10             	add    $0x10,%esp
80107481:	eb 9b                	jmp    8010741e <closeshmem+0xae>
