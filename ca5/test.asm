...
int main(int argc, char* argv[]) {
  ...
  23:	e8 c8 02 00 00       	call   2f0 <atoi>
  28:	89 04 24             	mov    %eax,(%esp)
  2b:	e8 20 00 00 00       	call   50 <factorial>
    exit();
  30:	e8 2e 03 00 00       	call   363 <exit>
        printf(2, "Usage: test number\n");
  35:	50                   	push   %eax
  36:	50                   	push   %eax
  ...
  3e:	e8 8d 04 00 00       	call   4d0 <printf>
        exit();
  43:	e8 1b 03 00 00       	call   363 <exit>
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
...
void factorial(int count) {
  ...
  57:	56                   	push   %esi
  58:	53                   	push   %ebx
  59:	8b 75 08             	mov    0x8(%ebp),%esi
    char* adr = openshmem(PAGE);
  5c:	83 ec 0c             	sub    $0xc,%esp
  5f:	6a 52                	push   $0x52
  61:	e8 9d 03 00 00       	call   403 <openshmem>
    printf(1, "%d\n", adr[0]);
  66:	83 c4 0c             	add    $0xc,%esp
    adr[0] = 1;
  69:	c6 00 01             	movb   $0x1,(%eax)
    printf(1, "%d\n", adr[0]);
  6c:	6a 01                	push   $0x1
  6e:	68 38 08 00 00       	push   $0x838
  73:	6a 01                	push   $0x1
  75:	e8 56 04 00 00       	call   4d0 <printf>
    for (int i = 1; i <= count; i++) {
  7a:	83 c4 10             	add    $0x10,%esp
  7d:	85 f6                	test   %esi,%esi
  7f:	7e 33                	jle    b4 <factorial+0x64>
  81:	bb 01 00 00 00       	mov    $0x1,%ebx
  86:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8d:	8d 76 00             	lea    0x0(%esi),%esi
        if (fork() == 0) {
  90:	e8 c6 02 00 00       	call   35b <fork>
  95:	85 c0                	test   %eax,%eax
  97:	74 2d                	je     c6 <factorial+0x76>
    for (int i = 1; i <= count; i++) {
  99:	83 c3 01             	add    $0x1,%ebx
  9c:	39 de                	cmp    %ebx,%esi
  9e:	7d f0                	jge    90 <factorial+0x40>
  a0:	31 db                	xor    %ebx,%ebx
  a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        wait();
  a8:	e8 be 02 00 00       	call   36b <wait>
    for (int i = 0; i < count; i++)
  ad:	83 c3 01             	add    $0x1,%ebx
  b0:	39 de                	cmp    %ebx,%esi
  b2:	75 f4                	jne    a8 <factorial+0x58>
    closeshmem(PAGE);
  b4:	c7 45 08 52 00 00 00 	movl   $0x52,0x8(%ebp)
}
  bb:	8d 65 f8             	lea    -0x8(%ebp),%esp
  be:	5b                   	pop    %ebx
  bf:	5e                   	pop    %esi
  c0:	5d                   	pop    %ebp
    closeshmem(PAGE);
  c1:	e9 45 03 00 00       	jmp    40b <closeshmem>
            int* adrs = (int*)openshmem(PAGE);
  c6:	83 ec 0c             	sub    $0xc,%esp
  c9:	6a 52                	push   $0x52
  cb:	e8 33 03 00 00       	call   403 <openshmem>
            printf(1, "%d\n", adrs[0]);
  d0:	83 c4 0c             	add    $0xc,%esp
            adrs[0] *= i;
  d3:	0f af 18             	imul   (%eax),%ebx
  d6:	89 18                	mov    %ebx,(%eax)
            printf(1, "%d\n", adrs[0]);
  d8:	53                   	push   %ebx
  d9:	68 38 08 00 00       	push   $0x838
  de:	6a 01                	push   $0x1
  e0:	e8 eb 03 00 00       	call   4d0 <printf>
            closeshmem(PAGE);
  e5:	c7 04 24 52 00 00 00 	movl   $0x52,(%esp)
  ec:	e8 1a 03 00 00       	call   40b <closeshmem>
            exit();
  f1:	e8 6d 02 00 00       	call   363 <exit>
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 50 08 00 00       	mov    $0x850,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 2c 0b 00 00       	mov    0xb2c,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 822:	00 00 00 
    if(p->s.size >= nunits){
