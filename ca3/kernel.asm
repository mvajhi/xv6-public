...
80104213:	68 97 7a 10 80       	push   $0x80107a97
...
80104c14:	68 74 78 10 80       	push   $0x80107874
...
80104c2c:	68 73 78 10 80       	push   $0x80107873
...
80104c41:	68 67 78 10 80       	push   $0x80107867
...
80104c5f:	68 76 78 10 80       	push   $0x80107876
80104c64:	e8 27 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 58 78 10 80       	push   $0x80107858
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 74 78 10 80       	push   $0x80107874
...
80105078:	68 73 78 10 80       	push   $0x80107873
...
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 b9 78 10 80       	push   $0x801078b9
...
801059a4:	3e ff 24 85 60 79 10 	notrack jmp *-0x7fef86a0(,%eax,4)
801059ab:	80 
    lapiceoi();
    break;
...
80105a01:	68 1c 79 10 80       	push   $0x8010791c
...
80105b1c:	68 c4 78 10 80       	push   $0x801078c4
...
80105b44:	0f 85 0e ff ff ff    	jne    80105a58 <trap+0xd8>
    if(ticks % 100 == 0)
80105b4a:	69 05 a0 56 11 80 29 	imul   $0xc28f5c29,0x801156a0,%eax
80105b51:	5c 8f c2 
80105b54:	c1 c8 02             	ror    $0x2,%eax
80105b57:	3d 28 5c 8f 02       	cmp    $0x28f5c28,%eax
80105b5c:	0f 87 f6 fe ff ff    	ja     80105a58 <trap+0xd8>
      yield();
80105b62:	e8 79 e3 ff ff       	call   80103ee0 <yield>
80105b67:	e9 ec fe ff ff       	jmp    80105a58 <trap+0xd8>
...
80105bcd:	ff 73 30             	pushl  0x30(%ebx)
80105bd0:	68 e8 78 10 80       	push   $0x801078e8
80105bd5:	e8 d6 aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bda:	83 c4 14             	add    $0x14,%esp
80105bdd:	68 be 78 10 80       	push   $0x801078be
