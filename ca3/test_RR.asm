...
_test_RR:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  13:	83 ec 10             	sub    $0x10,%esp
    int pid = fork();
  16:	e8 f0 02 00 00       	call   30b <fork>
    if (pid < 0)
  1b:	85 c0                	test   %eax,%eax
  1d:	78 5e                	js     7d <main+0x7d>
    {
        return 1;
    }
    if (pid == 0)
  1f:	74 6b                	je     8c <main+0x8c>
        {
    ...
    pid = fork();
  21:	e8 e5 02 00 00       	call   30b <fork>
  26:	89 c3                	mov    %eax,%ebx
    if (pid < 0)
  28:	85 c0                	test   %eax,%eax
  2a:	78 51                	js     7d <main+0x7d>
    {
        return 1;
    }
    if (pid == 0)
  2c:	74 32                	je     60 <main+0x60>
        {
  ...
  6c:	6a 01                	push   $0x1
  6e:	e8 fd 03 00 00       	call   470 <printf>
        for (int i = 0; i < 10; i++)
  ...
  8c:	52                   	push   %edx
  8d:	50                   	push   %eax
  8e:	68 d8 07 00 00       	push   $0x7d8
  93:	6a 01                	push   $0x1
  95:	89 45 f4             	mov    %eax,-0xc(%ebp)
  ...
  b5:	31 c0                	xor    %eax,%eax
{
  ...
  d1:	5d                   	pop    %ebp
  d2:	c3                   	ret
  d3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  da:	00 
...
free(void *ap)
{
 ...
 645:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
